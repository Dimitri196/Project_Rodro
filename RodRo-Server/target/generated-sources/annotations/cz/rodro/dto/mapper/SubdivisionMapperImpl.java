...
public class SubdivisionMapperImpl implements SubdivisionMapper {
    ...
    public SubdivisionDTO toSubdivisionDTO(SubdivisionEntity entity) {
        ...
        subdivisionDTO.setDistrict( districtEntityToDistrictDTO( entity.getDistrict() ) );
    ...
    protected DistrictDTO districtEntityToDistrictDTO(DistrictEntity districtEntity) {
        if ( districtEntity == null ) {
            return null;
        }
