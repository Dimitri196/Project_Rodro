...
public abstract class ProvinceEntity_ {
	...
	/**
	 * @see cz.rodro.entity.ProvinceEntity#provinceFlagImgUrl
	 **/
	public static volatile SingularAttribute<ProvinceEntity, String> provinceFlagImgUrl;

	public static final String COUNTRY = "country";
	public static final String DISTRICTS = "districts";
	public static final String ID = "id";
	public static final String PROVINCE_NAME = "provinceName";
	public static final String PROVINCE_FLAG_IMG_URL = "provinceFlagImgUrl";
