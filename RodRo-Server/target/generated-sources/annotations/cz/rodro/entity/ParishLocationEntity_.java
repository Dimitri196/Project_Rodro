...
public abstract class ParishLocationEntity_ {
	...
	/**
	 * @see cz.rodro.entity.ParishLocationEntity#mainChurchName
	 **/
	public static volatile SingularAttribute<ParishLocationEntity, String> mainChurchName;
	
	/**
	 * @see cz.rodro.entity.ParishLocationEntity#mainLocation
	 **/
	public static volatile SingularAttribute<ParishLocationEntity, Boolean> mainLocation;
