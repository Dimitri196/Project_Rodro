  ...
  return (
    <div className="container my-5">
      ...
      <div className="d-flex justify-content-between align-items-center mb-4">
        ...
        {isAdmin && (
          <Link to="/occupations/create" className="btn btn-success shadow-sm">
            <i className="fas fa-plus me-2"></i>Create Occupation
          </Link>
        )}
      </div>
                ...
                {currentItems.length > 0 ? (
                  currentItems.map((item, index) => (
                    <tr key={item._id}>
                      ...
                      <td className="py-2 px-4">{item.occupationName}</td>
                      ...
                      {isAdmin && (
                        <td className="py-2 px-4 text-center">
                          <div className="d-flex justify-content-center gap-2">
                            <Link to={`/occupations/show/${item._id}`} className="btn btn-sm btn-info">
                              <i className="fas fa-eye"></i> View
                            </Link>
                            <Link to={`/occupations/edit/${item._id}`} className="btn btn-sm btn-warning">
                              <i className="fas fa-edit"></i> Edit
                            </Link>
                            <Button onClick={() => deleteOccupation(item._id)} className="btn btn-sm btn-danger">
