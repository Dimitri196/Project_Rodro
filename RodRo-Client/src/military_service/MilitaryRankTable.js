    ...
    return (
        <div className="container my-4">
            <div className="mb-3 d-flex justify-content-between align-items-center">
                ...
                <Link to="/militaryRanks/create" className="btn btn-success">Create</Link>
            </div>
                ...
                <table className="table table-bordered table-striped">
                    ...
                    <tbody>
                            ...
                            <tr key={item.id}>
                                ...
                                <td>
                                    <div className="btn-group">
                                        <Link to={`/militaryRanks/show/${item._id}`} className="btn btn-sm btn-info mx-1">View</Link>
                                        <Link to={`/militaryRanks/edit/${item._id}`} className="btn btn-sm btn-warning mx-1">Edit</Link>
                        ...
                        {currentItems.length === 0 && (
                            <tr>
                                <td colSpan="9" className="text-center">No military ranks found.</td>
                            </tr>
                        )}
                    </tbody>
                </table>
