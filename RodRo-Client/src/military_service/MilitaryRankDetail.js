...
const MilitaryRankDetail = () => {
  ...
  return (
    <Container className="mt-5">
      ...
      <Row>
        <Col>
          <h3>Persons holding this rank</h3>
          {!rank.persons || rank.persons.length === 0 ? (
            <p>No persons found for this rank.</p>
          ) : (
            rank.persons.map((person) => (
              <Card key={person.personId} className="mb-3">
                <Card.Body>
                  <Card.Title>
                  ...
                  <ListGroup variant="flush">
                    <ListGroup.Item>
                      <strong>Enlistment Year:</strong> {person.enlistmentYear || "-"}
                    </ListGroup.Item>
                    <ListGroup.Item>
                      <strong>Discharge Year:</strong> {person.dischargeYear || "-"}
                    </ListGroup.Item>
